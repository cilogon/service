...
/* If the CSRF cookie was good and the user clickecd the "Submit" *
...
if ($submit == 'Submit') {
    ...
    if ((strlen($yourName) > 2) &&
        ...
        printFormSubmitted($yourName,$emailAddr,$selectIdP,$otherIdP,$comments);
    } else {
        ...
        printMainForm(true,$yourName,$emailAddr,$selectIdP,$otherIdP,$comments);
    }
 ...
 ************************************************************************/
function printMainForm($verify=false,$yourName='',$emailAddr='',
 ...
 * page to the user.                                                    *
 ************************************************************************/
function printFormSubmitted($yourName,$emailAddr,$selectIdP,$otherIdP,$comments)
{
