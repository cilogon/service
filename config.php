...
define('FORCE_SKIN_ARRAY', array(
    ...
    '%^https://agri-clowder.ncsa.illinois.edu/authenticate/cilogon%' => 'sprouttest',
    '%^https://agri-clowder.ncsa.illinois.edu/clowder/authenticate/cilogon%' => 'sprouttest',
    '%^https://simpl.ncsa.illinois.edu/clowder/authenticate/cilogon%' => 'sprouttest',
